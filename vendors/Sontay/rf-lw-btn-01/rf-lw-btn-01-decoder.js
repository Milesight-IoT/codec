...
function _remap(d) {
  ...
  if (d.thermistorProperlyConnected !== undefined) out.thermistor_connection_status = d.thermistorProperlyConnected ? 1 : 0;
  if (d.sensorTemperature           !== undefined) out.sensor_temp                  = d.sensorTemperature;
  if (d.pressEvent                  !== undefined) out.press_event                  = typeof d.pressEvent === 'object' ? JSON.stringify(d.pressEvent) : d.pressEvent;
  if (d.singlePressEventCounter     !== undefined) out.single_press_counter         = d.singlePressEventCounter;
  if (d.doublePressEventCounter     !== undefined) out.double_press_counter         = d.doublePressEventCounter;
  if (d.triplePressEventCounter     !== undefined) out.triple_press_counter         = d.triplePressEventCounter;
  return out;
}
