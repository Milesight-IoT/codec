...
function _remap(d) {
  ...
  if (d.relativeHumidity     !== undefined) out.humidity                     = d.relativeHumidity;
  ...
  if (d.openWindow           !== undefined) out.open_window_status           = d.openWindow;
  if (d.childLock            !== undefined) out.child_lock_status            = d.childLock ? 1 : 0;
  if (d.highMotorConsumption !== undefined) out.high_motor_consumption_alarm = d.highMotorConsumption;
  if (d.lowMotorConsumption  !== undefined) out.low_motor_consumption_alarm  = d.lowMotorConsumption;
  if (d.brokenSensor         !== undefined) out.broken_sensor_alarm          = d.brokenSensor;
