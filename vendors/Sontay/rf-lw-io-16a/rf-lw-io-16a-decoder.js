...
function _remap(d) {
  var out = {};
  if (d.internalTemperature !== undefined) out.internal_temp = d.internalTemperature;
  if (d.energy_kWh          !== undefined) out.energy        = d.energy_kWh;
  if (d.power_W             !== undefined) out.power         = d.power_W;
  if (d.acVoltage_V         !== undefined) out.ac_voltage    = d.acVoltage_V;
  if (d.acCurrent_mA        !== undefined) out.ac_current    = d.acCurrent_mA;
  if (d.relayState          !== undefined) out.relay_state   = d.relayState === 'ON' ? 1 : 0;
  return out;
}
