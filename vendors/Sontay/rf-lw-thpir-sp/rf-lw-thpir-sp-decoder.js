...
function _remap(d) {
  ...
  if (d.lux                           !== undefined) out.illumination                     = d.lux;
  if (d.pir                           !== undefined) out.occupied                         = d.pir;
  if (d.manualTargetTemperatureUpdate !== undefined) out.manual_target_temperature_update = d.manualTargetTemperatureUpdate;
  return out;
}
