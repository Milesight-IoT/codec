...
function _remap(d) {
  ...
  if (d.operationalMode   !== undefined) out.operational_mode   = d.operationalMode;
  if (d.displayedFanSpeed !== undefined) out.fan_speed          = d.displayedFanSpeed;
  if (d.actualFanSpeed    !== undefined) out.actual_fan_speed   = d.actualFanSpeed;
  if (d.valveStatus       !== undefined) out.valve_status       = d.valveStatus;
  if (d.deviceStatus      !== undefined) out.device_status      = d.deviceStatus;
  return out;
}
