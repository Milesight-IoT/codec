...
function _remap(d) {
  ...
  if (d.thermistorProperlyConnected !== undefined) out.thermistor_connected     = d.thermistorProperlyConnected;
  if (d.temperature                 !== undefined) out.thermistor_temperature   = d.temperature;
  if (d.counter                     !== undefined) out.counter                  = d.counter;
