...
function _remap(d) {
  ...
  if (d.targetTemperature     !== undefined) out.target_temperature      = d.targetTemperature;
  if (d.sensorTemperature     !== undefined) out.sensor_temperature      = d.sensorTemperature;
  if (d.relativeHumidity      !== undefined) out.relative_humidity       = d.relativeHumidity;
  if (d.motorRange            !== undefined) out.motor_range             = d.motorRange;
  if (d.motorPosition         !== undefined) out.motor_position          = d.motorPosition;
  if (d.batteryVoltage        !== undefined) out.battery_voltage         = d.batteryVoltage;
  if (d.openWindow            !== undefined) out.open_window             = d.openWindow;
  if (d.childLock             !== undefined) out.child_lock              = d.childLock;
  if (d.highMotorConsumption  !== undefined) out.high_motor_consumption  = d.highMotorConsumption;
  if (d.lowMotorConsumption   !== undefined) out.low_motor_consumption   = d.lowMotorConsumption;
  if (d.brokenSensor          !== undefined) out.broken_sensor           = d.brokenSensor;
  if (d.attachedBackplate     !== undefined) out.attached_backplate      = d.attachedBackplate;
  if (d.calibrationFailed     !== undefined) out.calibration_failed      = d.calibrationFailed;
  if (d.perceiveAsOnline      !== undefined) out.perceive_as_online      = d.perceiveAsOnline;
  if (d.antiFreezeProtection  !== undefined) out.anti_freeze_protection  = d.antiFreezeProtection;
  if (d.valveOpenness         !== undefined) out.valve_openness          = d.valveOpenness;
  return out;
}
