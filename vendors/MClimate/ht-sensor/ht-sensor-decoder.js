...
function _remap(d) {
  ...
  if (d.thermistorProperlyConnected !== undefined) out.thermistor_properly_connected = d.thermistorProperlyConnected;
  if (d.extThermistorTemperature   !== undefined) out.ext_thermistor_temperature   = d.extThermistorTemperature;
  return out;
}
