...
function _decode(bytes){
  ...
  switch(fc){
    case 0x53: {
      out.delta_pressure = _i16be(bytes, 2);
      break;
    }
    case 0x54: {
      out.delta_pressure_alarm = !!bytes[2];
      out.delta_pressure = _i16be(bytes, 3);
      break;
    }
    case 0x55: {
      out.analog = _i16be(bytes, 2);
      break;
    }
    case 0x56: {
      out.analog_alarm = !!bytes[2];
      out.analog = _i16be(bytes, 3);
      break;
    }
    case 0x51: {
      out.digital_1_global_counter = _u32be(bytes, 3);
      out.digital_1_instant_counter = _u16be(bytes, 7);
      break;
    }
    case 0x52: {
      out.digital_2_global_counter = _u32be(bytes, 3);
      out.digital_2_instant_counter = _u16be(bytes, 7);
      break;
    }
    case 0x20: {
      if (bytes.length === 4) {
