...
function syncTime(sync_time) {
    ...
    if (!sync_time_values.includes(sync_time)) {
...
function reportStatus(report_status) {
    ...
    if (!report_status_values.includes(report_status)) {
...
function setHistoryEnable(history_enable) {
    ...
    if (!history_enable_values.includes(history_enable)) {
...
function clearHistory(clear_history) {
    ...
    if (!clear_history_values.includes(clear_history)) {
...
function setRetransmitEnable(retransmit_enable) {
    ...
    if (!retransmit_enable_values.includes(retransmit_enable)) {
...
function stopTransimit(stop_transimit) {
    ...
    if (!stop_transimit_values.includes(stop_transimit)) {
